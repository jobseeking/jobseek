	...
	<div class="post_form" id="" >
		<div class="well">
			...
			<form class="form-horizontal" action="{{$base_url}}/update_user" method="post">
			  ...
			  <div class="form-group">
				<div class="col-xs-6">
				  <input disabled type="text" class="form-control" id="FirstName" name="name" placeholder="First name" value="{{$user->name}}">
				</div>

				 <div class="col-xs-6">
				  <input disabled type="text" class="form-control" id="LastName" name="last_name" placeholder="Last name" value="{{$user->last_name}}">
				</div>
			  </div>
